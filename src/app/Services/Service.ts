...
export class Service {
  ...
  private api =
    'https://apiamecae-h7fverbshphnbycs.eastus2-01.azurewebsites.net/CliniaOv/CliniaOvController/';
  private apiTratamientos =
    'https://apiamecae-h7fverbshphnbycs.eastus2-01.azurewebsites.net/api/Tratamientos/TratamientosController/';
